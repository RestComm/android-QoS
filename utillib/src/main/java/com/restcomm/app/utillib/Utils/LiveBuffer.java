...
import com.restcomm.app.utillib.ContentProvider.UriMatch;
...
public class LiveBuffer {
	...
	public void updateActivityFromDB(long timespan){
		...
		DeviceInfo device = reportManager.getDevice();
...
//			);
		...
		{
			LoggerUtil.logToFile(LoggerUtil.Level.DEBUG, "LiveBuffer", "updateActivityFromDB", "error with query", e);
		}
		...
		{
			LoggerUtil.logToFile(LoggerUtil.Level.DEBUG, "LiveBuffer", "updateActivityFromDB", "error with basestations query", e);
		}
		...
		if (bLocations)
		{
			...
			{
				LoggerUtil.logToFile(LoggerUtil.Level.DEBUG, "LiveBuffer", "updateActivityFromDB", "error with locations query", e);
			}
		}
