...
public class VoiceQTest extends MMCTrackedActivityOld {
	...
	protected void onResume() {
		...
		try{
			...
			sampleSetting = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(this).getString("KEY_SETTINGS_VQ_SAMPLE",String.valueOf("1"))); // SAMPLE_16000
	...
	public void buttonTestDevice (View view) {
		...
		LoggerUtil.logToFile(LoggerUtil.Level.ERROR, TAG, "OnClickListener", "buttonTestDevice - test VQ Device");
...
//	private AsyncTask<Void, Void, String> mConnectTask;
	public void beginVoiceTest(View v) {
		...
		if (vqManager == null)
		{
			LoggerUtil.logToFile(LoggerUtil.Level.ERROR, TAG, "beginVoiceTest", "VQManager = null");
			return;
		}
        consoleText.setText("");
		setTestReady (false);
		...
		LoggerUtil.logToFile(LoggerUtil.Level.ERROR, TAG, "OnClickListener", "beginVoiceTest");
		sendBroadcast(intent);
	}
//		
//		
...
//	}
	...
	public void topMenuActionClicked(View button){
		...
		if(currentTime-DropDownMenuWindow.lastWindowDismissedTime>200){
			...
			FontsUtil.applyFontToTextView(Constants.font_Regular, settings, this);
