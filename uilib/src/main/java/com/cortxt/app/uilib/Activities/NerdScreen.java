...
import com.cortxt.app.uilib.Activities.CustomViews.DropDownMenuWindow;
import com.cortxt.app.uilib.Activities.CustomViews.NerdView;
import com.cortxt.app.uilib.Activities.CustomViews.SatelliteCount;
import com.cortxt.app.uilib.Activities.CustomViews.SatelliteStatus;
import com.cortxt.app.uilib.Activities.CustomViews.Chart.Chart;
...
//		}
		...
		LoggerUtil.logToFile(LoggerUtil.Level.DEBUG, "NerdScreen", "onCreate", "height: " + height + " width: " + width);
		if (height <= width) {
		...
		FontsUtil.applyFontToTextView(Constants.font_Regular, heading, NerdScreen.this);
...
//							nerdview.setValue(1, "Channel", null);
	...
	/**
	 * MainService sends messages to this activity through intents. This class is responsible for receiving those intents
	...
	public void menuActionClicked(View menuButton) {
		...
		if (currentTime - DropDownMenuWindow.lastWindowDismissedTime > 200) {
			...
			FontsUtil.applyFontToTextView(Constants.font_Regular, gpsColdStartOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, updateOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, HistoryOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, smsTestStartOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, latencyTestOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, voiceTestOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, videoTestOption, this);
            FontsUtil.applyFontToTextView(Constants.font_Regular, audioTestOption, this);
            FontsUtil.applyFontToTextView(Constants.font_Regular, webTestOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, youTubeOption, this);
            FontsUtil.applyFontToTextView(Constants.font_Regular, websocketOption, this);
			FontsUtil.applyFontToTextView(Constants.font_Regular, appUsageOption, this);
			//FontsUtil.applyFontToTextView(Constants.font_Regular, rawTestOption, this);
...
//            }
			...
			engineerMenu = new DropDownMenuWindow(menuOptionsView, this, Constants.MAP_MENU_OFFSET, Constants.GENERAL_MENU_WINDOW_WIDTH);
	...
	android.view.View.OnClickListener updateEventClickListener = new android.view.View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			//MainService.startEvent (NerdScreen.this, EventType.EVT_VQ_CALL);
			//MainService.startDriveTest(NerdScreen.this, 15, true, 2, 0, 0, 5, 0, 2, 0);
	...
	android.view.View.OnClickListener videoTestClickListener=new android.view.View.OnClickListener () {
		...
		public void onClick(View v) {
			...
			Intent intent = new Intent(NerdScreen.this, ActiveTestsActivity.class);
			startActivity(intent);
			if(engineerMenu!=null){
				engineerMenu.dismissWindow();
			}
