package com.cortxt.app.uilib.Activities.MyCoverage;
...
import com.cortxt.app.uilib.Activities.EventHistory;
import com.cortxt.app.uilib.Activities.MMCActivity;
import com.cortxt.app.uilib.Activities.MMCTrackedActivityOld;
import com.cortxt.app.uilib.Activities.MyCoverage.CoverageMapFragment;
import com.cortxt.app.uilib.Activities.MyCoverage.CoverageOverlay;
import com.cortxt.app.uilib.Activities.MyCoverage.EventsOverlay.EventOverlayItem;
import com.cortxt.app.uilib.Activities.MyCoverage.EventsOverlay.EventsOverlay;
import com.cortxt.app.uilib.Activities.CustomViews.DropDownMenuWindow;
import com.cortxt.app.uilib.Activities.CustomViews.Fragments.EventHistoryFragment;
import com.cortxt.app.uilib.Activities.MyCoverage.MyCoverageMapActivity;
import com.cortxt.app.uilib.Activities.MyCoverage.MMCMapView;
import com.cortxt.app.uilib.Activities.ShareTask;
...
public class MyCoverage extends MMCTrackedActivityOld {
	...
	protected void onCreate(Bundle bundle) {
		...
		FontsUtil.applyFontToTextView(Constants.font_Regular, mapTitle, this);
		FontsUtil.applyFontToButton(Constants.font_Regular, bottomShareButton, this);
	...
	public void MapMenuIconClicked(View view){
		...
		if(currentTime-DropDownMenuWindow.lastWindowDismissedTime>200){
			...
			if (this.getResources().getInteger(R.integer.MAP_SWITCH_CARRIER) == 1 && carrierCovOnly != 1) {
				...
				FontsUtil.applyFontToTextView(Constants.font_Regular, overlaysOption, this);
			}
...
//			if(true) { //TODO: remove after testing
			...
			coverageMenu=new DropDownMenuWindow(menuOptionsView,this,Constants.MAP_MENU_OFFSET,Constants.GENERAL_MENU_WINDOW_WIDTH);
