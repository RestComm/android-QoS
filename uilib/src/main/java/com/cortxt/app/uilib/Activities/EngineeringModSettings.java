...
//	CheckBox remoteTesting = null;
	...
	private void applyFonts(View view){
		...
		FontsUtil.applyFontToTextView(Constants.font_Regular, heading, this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, recordSessionText, this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, dataTypeText, this);
		...
		//FontsUtil.applyFontToButton(Constants.font_Regular, boxCov, this);
		//FontsUtil.applyFontToButton(Constants.font_Regular, boxSpeedTest, this);
		
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView) view.findViewById(R.id.intervalCoverage), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalSpeed), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalSMS), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalVideo), this);
        FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalAudio), this);
        FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalWeb), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalVQ), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalYouTube), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalPing), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalVQ), this);
		FontsUtil.applyFontToTextView(Constants.font_Regular, (TextView)view.findViewById(R.id.intervalConnect), this);
