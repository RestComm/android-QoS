...
import com.cortxt.app.uilib.Activities.SpeedTestHistory;
...
public class SpeedTestHistoryFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		FontsUtil.applyFontToTextView(Constants.font_Regular, titleText, getActivity());
		FontsUtil.applyFontToTextView(Constants.font_MEDIUM, dateText, getActivity());
		FontsUtil.applyFontToTextView(Constants.font_MEDIUM, typeText, getActivity());
		FontsUtil.applyFontToTextView(Constants.font_MEDIUM, latencyText, getActivity());
		FontsUtil.applyFontToTextView(Constants.font_MEDIUM, downloadtext, getActivity());
		FontsUtil.applyFontToTextView(Constants.font_MEDIUM, uploadText, getActivity());
	...
	private class SpeedHistoryAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			FontsUtil.applyFontToTextView(Constants.font_Regular, latencySpeed, getActivity());
			FontsUtil.applyFontToTextView(Constants.font_Regular, downSpeed, getActivity());
			FontsUtil.applyFontToTextView(Constants.font_Regular, upSpeed, getActivity());
			FontsUtil.applyFontToTextView(Constants.font_Regular, speedDate, getActivity());
