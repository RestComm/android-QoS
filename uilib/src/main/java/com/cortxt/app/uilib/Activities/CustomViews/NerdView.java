package com.cortxt.app.uilib.Activities.CustomViews;
...
import com.cortxt.app.uilib.Activities.NerdScreen;
...
public class NerdView extends View {
	...
	private void init(Context context) {
		...
		Typeface customFont = FontsUtil.getCustomFont(Constants.font_Regular, context);
