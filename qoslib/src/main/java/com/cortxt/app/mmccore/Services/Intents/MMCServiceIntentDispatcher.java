 ...
 *
 */
public class MMCServiceIntentDispatcher {
	private static final String TAG = MMCServiceIntentDispatcher.class.getSimpleName();
	 ...
	 * Starts constructors
	 */
	public MMCServiceIntentDispatcher(MMCService owner){
		this.owner = owner;
	}
	/*
	 * End constructors
...
//		}
	...
	public void markEvent(EventType event){
		...
		intent.putExtra(MMCIntentHandler.EXTRA_EVENTTYPE, event.getIntValue());
		owner.sendBroadcast(intent);
	}
