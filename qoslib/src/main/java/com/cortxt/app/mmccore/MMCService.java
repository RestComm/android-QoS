...
import com.cortxt.app.mmcutility.ContentProvider.ContentValuesGenerator;
import com.cortxt.app.mmcutility.ContentProvider.Provider;
import com.cortxt.app.mmcutility.ContentProvider.TablesEnum;
	...
	public void pruneDB() {
		new Thread(
			new Runnable() {
				@Override
				public void run() {
					Provider provider = getDBProvider(MMCService.this);//ContentResolver().acquireContentProviderClient(Tables.AUTHORITY).getLocalContentProvider();
					provider.pruneDB();
